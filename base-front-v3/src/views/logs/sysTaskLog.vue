    ...
    <div class="main-body">
        ...
        <div class="toolbar">
            <el-form :inline="true" :model="filters">
                                <el-form-item>
                    <el-button icon="search" type="primary" v-if="$hasBP('bnt.sysTaskLog.list') " @click="doSearch">{{ t('action.search') }}</el-button>
                </el-form-item>
                <el-form-item>
                    <el-button  icon="refresh" type="primary" v-if="$hasBP('bnt.sysTaskLog.list')"  @click="refreshForm">{{ t('action.reset') }}</el-button>
                </el-form-item>
            </el-form>
        </div>
        <!--表格内容栏-->
...
<script setup>
    import api from "@/apis/logs-tasks";
